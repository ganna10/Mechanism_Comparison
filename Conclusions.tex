...
\ce{O_x} produced from VOC in lumped molecule and structure mechanisms have larger differences on the first day to the MCM v3.2 than the CRI v2, which lumps degradation products.
...
Many unsaturated VOC produce similar amounts of \ce{O_x} between mechanisms, especially VOC that are explicitly represented.
...
\ce{O_x} produced during the degradation of aromatic VOC show the largest differences between the mechanisms; improved degradation chemistry and more mechanism species representing aromatic VOC would improve the representation of aromatic degradation.
