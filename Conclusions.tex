...
Reduced mechanisms generally produced lower but similar \ce{O_x} levels to near-explicit mechanisms.
Increased reactive carbon loss rates result in lower \ce{O_x} production in less-explicit mechanisms.
Higher reactive carbon loss was compensated by a higher \ce{O_x} production efficiency in less-explicit mechanisms. 
For some VOCs, incorrect chemistry or inadequate representation in reduced mechanisms led to reduced \ce{O_x} production.
