...
Applying the tagging approach over multi-day scenarios revealed that VOC, such as alkanes, produce maximum \ce{O3} production on the second day of the model run; in contrast to unsaturated and aromatic VOC which produce maximum \ce{O3} on the first day.
...
In this study, the tagging approach of \citet{Butler:2011} is applied to several chemical mechanisms under conditions of maximum \ce{O3} production in the \ce{NO_x}-VOC-sensitive regime comparing the effects of different representations of VOC degradation chemistry on \ce{O3} production in the different chemical mechanisms.
