...
Subsequent generation oxidation products can continue to react, producing \ce{HO2} and \ce{RO2} until they have been completely oxidised to \ce{CO2} and \ce{HO2}.
...
Tagging enables the attribution of \ce{O3} production from VOC degradation products back to the originally emitted VOC, thus providing detailed insight into VOC degradation chemistry.
...
The Common Representative Intermediates mechanism (CRI) lumps the degradation products of VOC instead of the emitted VOC \citep{Jenkin:2008}.
...
The largest discrepancies between the time series of \ce{O3} concentrations in different mechanisms in these studies arise when modelling urban rather than rural conditions and have been attributed to the treatment of radical production, organic nitrate and night-time chemistry.
