...
The production of \ce{O_x} family is closely tied to that of \ce{O3} as demonstrated in \citet{Butler:2011}.
...
\begin{figure}
    ...
    \label{f:Ox_budget}
\end{figure} 
\todo{change VOC colours to those in Ox Production budgets in all mechanisms plot}
