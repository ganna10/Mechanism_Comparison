...
The production of \ce{O_x} is closely tied to that of \ce{O3} as demonstrated in \citet{Butler:2011}.
...
The TOPP for a given VOC is the number of \ce{O_x} molecules produced per emitted VOC molecule and is defined as the daily contribution to \ce{O_x} production from a VOC normalised by the total emissions of the VOC.
