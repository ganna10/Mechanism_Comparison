...
VOC degradation is represented by species whose \ce{O3} production reflects that of the \mbox{MCM v3.1}. 
...
%CB05
The fifth version of the Carbon Bond Mechanism (CB05) \citep{Yarwood:2005} includes explicit species to represent methane, ethane and acetaldehyde. 
...
Maximum \ce{O3} production is achieved by balancing the chemical sources of radicals and \ce{NO_x} with the appropriate amount of NO emissions at each time step.
...
Methane (\ce{CH4}) was fixed at \mbox{$1.8$ ppmv}. 
Carbon monoxide (CO) and \ce{O3} were initialised at \mbox{$200$ ppbv} and \mbox{$40$ ppbv} and then allowed to evolve freely.

Table \ref{t:initial_conditions} outlines the NMVOC used in the study, their mixing ratios and representation in the each mechanism.
