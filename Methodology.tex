...
\citet{Butler:2011} show that \ce{O_x} and \ce{O3} production are closely related.
...
The \ce{O_x} production budget is allocated to individual VOC by following the VOC tags \mbox{(Figure \ref{f:Ox_budget} (a)).}
...
The TOPP for a VOC is the number of \ce{O_x} molecules produced per emitted VOC molecule and is defined as the daily contribution to \ce{O_x} production from a VOC normalised by the total emissions of the VOC.
