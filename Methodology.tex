...
%CRI
The Common Representative Intermediates (CRI v2) \citep{Jenkin:2008} is a reduced chemical mechanism describing the oxidation of the same primary VOC as the \mbox{MCM v3.1}. 
...
We use the MECCA boxmodel \citep{Sander:2005} set up over Los Angeles and consider all gas-phase chemistry processes occurring below the planetary boundary layer.
...
The MECCA boxmodel is based upon the Kinetic Pre-Processor (KPP) \citep{Damian:2002} and used as described in \citet{Butler:2011}. 
...
The MCM v3.2 approach to photolysis, dry deposition of VOC oxidation intermediates, as well as \ce{RO2}--\ce{RO2} reactions was used for each mechanism.
...
The TOPP value of a VOC not represented explicitly in a chemical mechanism is calculated by scaling the TOPP value of the mechanism species representing the VOC by the ratio of the carbon numbers of the VOC to the mechanism species.
