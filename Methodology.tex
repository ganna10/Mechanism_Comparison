...
The radical and \ce{NO_x} amounts were balanced at each time step by emitting the amount of NO equalling the total radical chemical source minus the total \ce{NO_x} source.
The NO emission amounts were determined separately for each model run ensuring conditions for maximum \ce{O3} production for each mechanism.
