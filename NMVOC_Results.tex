...
CRI v2 and RACM2 both have a higher loss rate of reactive carbon on the second day compared to the MCM v3.2 but the both have in increase in \ce{O_x} production on the second day (Figure \ref{f:carbon}) and this is due to a higher Ox production efficiency in CRI v2 and RACM2 compared to the MCM v3.2 (Section \ref{ss:OxPE}).
