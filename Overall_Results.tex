...
\subsection[Time Series of Key Species and Ox Production Budgets]{Time Series of Key Species and \ce{O_x} Production Budgets}

\begin{figure}
    \centering
    %\includegraphics[width=\textwidth]{img/}
    \vspace{1mm}
    \caption{Time series of \ce{O3} and OH mixing ratios and NO source in each mechanism.}
    \vspace{-4mm}
    \label{f:time_series}
\end{figure}
...
Figure \ref{f:time_series} shows the time series of the mixing ratios for \ce{O3} and OH as well as the NO source obtained using each model.
%which mechanism is highest ? lowest ? difference in CBs
The day-time production budgets of the \ce{O_x} family for each mechanism are displayed in Figure \ref{f:Ox_tagged_budgets}, the \ce{O_x} production budget is allocated to each emitted VOC.
%comments
