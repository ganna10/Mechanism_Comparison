...
Mechanism differences in radical production would lead to different NO emissions in this study.
...
Most reduced mechanisms do not have sufficient carbonyl species to sustain radical production solely through carbonyl photolysis.
Initial VOC oxidation, NO--\ce{RO2} reactions and aromatic degradation product ozonolysis are used to sustain radical production in less-explicit mechanisms.
Examples of non-photolysis radical sources are given in Table \ref{t:thermal_radicals}.

Mechanisms require different NO emissions for \ce{NO_x}-VOC-sensitive conditions.
Thus, a constant NO source may lead to different atmospheric regimes being simulated in each mechanism.
...
This is represented in both MCM versions but is a minor source as \ce{NO_x}-VOC-sensitive conditions are used.  
...
This additional pathway results in the higher methyl glyoxal production from alkane degradation in these mechanisms.
