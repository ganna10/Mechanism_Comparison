...
Table~\ref{t:mechanisms} with a~brief summary below.  \DIFaddbegin \DIFadd{We used a subset 
of the chemical reactions fully describing the degradation of the VOC 
in Table~\ref{t:initial_conditions}.  }\DIFaddend The reduced
...
chemistry. \DIFaddbegin \DIFadd{The recent review by }\citet{Baklanov:2014} \DIFadd{shows that each
chemical mechanism used in this study are actively used by modelling
groups.
...
study \DIFaddbegin \DIFadd{due to its level of detail ($16\,349$ reactions). Despite this level of detail, the MCM
had difficulties in reproducing the results of chamber study
experiments involving aromatic VOC }\citep{Bloss:2005}\DIFaddend .

The CRI \citep{Jenkin:2008} is a~reduced chemical mechanism \DIFaddbegin \DIFadd{with $1145$ reactions }\DIFaddend describing
the oxidation of the same primary VOC as the MCM v3.1 \DIFaddbegin \DIFadd{($12\,691$ reactions)}\DIFaddend .  VOC
...
production reflects that of the MCM v3.1.  The \DIFaddbegin \DIFadd{CRI~v2 is available in
...
the VOC. \DIFaddbegin \DIFadd{Tropospheric chemistry is described by $145$ reactions in MOZART-4.
}\DIFaddend 

RADM2 \citep{Stockwell:1990} describes regional scale atmospheric
chemistry \DIFaddbegin \DIFadd{using $145$ reactions }\DIFaddend with explicit species representing methane, ethane, ethene
...
representing VOC as well as revised chemistry \DIFaddbegin \DIFadd{($193$ reactions)}\DIFaddend .  RACM2 is the updated
...
emitted VOC \DIFaddbegin \DIFadd{($315$ reactions)}\DIFaddend .

CBM-IV \citep{Gery:1989} \DIFdelbegin \DIFdel{simulates }\DIFdelend \DIFaddbegin \DIFadd{uses $46$ reactions to simulate }\DIFaddend polluted urban conditions and
...
species representing methane, ethane and acetaldehyde\DIFaddbegin \DIFadd{, and has $99$ reactions}\DIFaddend .  Other updates
...
The \DIFaddbegin \chem{O_3} \DIFadd{mixing ratios in Fig.~\ref{f:time_series} are
not simply determined by the explicitness of the chemical mechanism.
...
\DIFdel{) produced by the MCMv3.2. The OH-oxidation of }%DIFDELCMD < \chem{CH_3CHO} %%%
\DIFdel{starts a~degradation
chain that
produces O$_{x}$ }\DIFdelend \DIFaddbegin \DIFadd{the degradation
of HC3 does not produce a high yield of the less reactive ketones compared
to the MCM. The further degradation of ketones hinders }\chem{O_x} \DIFadd{production
due to its low OH reactivity and photolysis rate. Thus further degradation
of HC3 proceeds through the degradation of acetaldehyde (}\chem{CH3CHO}\DIFadd{) which
propogates }\chem{O_x} \DIFadd{production }\DIFaddend through the reactions of \chem{CH_3CO_3} and
\chem{CH_3O_2} with \chem{NO}; thus the \DIFdelbegin \DIFdel{higher amounts of
}%DIFDELCMD < \chem{CH_3CHO} %%%
\DIFdel{in RADM2 during propane degradation }\DIFdelend \DIFaddbegin \DIFadd{lower ketone yields }\DIFaddend leads to increased
...
\DIFdel{production from degradation }\DIFdelend \DIFaddbegin \DIFadd{more efficient production }\DIFaddend of unsaturated dicarbonyls \DIFdelbegin \DIFdel{; }%DIFDELCMD < \chem{C_2H_5O_2} %%%
\DIFdel{is not produced during
degradation of unsaturated dicarbonyls in the MCM}\DIFdelend \DIFaddbegin \DIFadd{than
the MCM~}\DIFaddend v3.2. \DIFaddbegin \DIFadd{The degradation of unsaturated dicarbonyls produces peroxy
radicals such as }\chem{C_2H_5O_2} \DIFadd{which promote }\chem{O_x} \DIFadd{production.
...
\DIFaddend \bibitem[{Bloss et~al.(2005)Bloss, Wagner, Jenkin, Vollamer, Bloss,
...
\DIFaddend \bibitem[{Dodge(2000)}]{Dodge:2000} Dodge,~M.: {Chemical oxidant
...
\DIFaddend \bibitem[{EEA(2014)}]{AQEU:2014} EEA: {Air quality in Europe -- 2014
...
\DIFaddend \bibitem[{Gery et~al.(1989)Gery, Whitten, Killus, and
...
\DIFaddend \bibitem[{Harwood et~al.(2003)Harwood, Roberts, Frost, Ravishankara,
...
\DIFaddend \bibitem[{HTAP(2010)}]{HTAP:2010} HTAP: Hemispheric Transport of Air
...
%DIFDELCMD <   %%%
\DIFdelend \DIFaddbegin \bibitem[{Li et.~al.(2014)Li, Georgescu, Hydpe, Mahalov, and Moustaui}]{Li:2014}\DIFadd{Li,~J, Georgescu,~M., Hyde,~P., Mahalov,~A. and Moustaoui,~M.: Achieving accurate simulations of urban impacts on ozone at high resolution, Environmental Research Letters, 9, 11, 114019, 2014.
  }


\bibitem[{Rickard et~al.(2015)Rickard, Young, Pilling, Jenkin, Pascoe, and Saunders}]{MCM_Site} \DIFaddend Rickard,~A., Young,~J., \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{Pilling,~M., Jenkin.~M., }\DIFaddend Pascoe,~S.\DIFaddbegin \DIFadd{, and Saunders~S.}\DIFaddend : {The Master Chemical Mechanism Version MCM v3.2}, available at: \url{http://mcm.leeds.ac.uk/MCMv3.2/} (last access: \DIFdelbegin \DIFdel{25 March }\DIFdelend \DIFaddbegin \DIFadd{15 July }\DIFaddend 2015), 2015.
...
\DIFaddend \bibitem[{Yarwood et~al.(2005)Yarwood, Rao, Yocke, and Whitten}]{Yarwood:2005}
