...
\DIFaddbegin \bibitem[{Li et~al.(2014)Li, Georgescu, Hydpe, Mahalov, and Moustaui}]{Li:2014}\DIFadd{Li,~J, Georgescu,~M., Hyde,~P., Mahalov,~A. and Moustaoui,~M.: Achieving accurate simulations of urban impacts on ozone at high resolution, Environmental Research Letters, 9, 11, 114019, 2014. }\DIFaddend

  \DIFaddbegin \bibitem[{Lidster et~al.(2014)Lidster, Hamilton, Lee, Lewis, Hopkins, Punjabi, Rickard and Young}]{Lidster:2014} \DIFadd{Lidster,~R.~T., Hamilton,~J.~F., Lee,~J.~D., Lewis}\DIFaddend ,~A.\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{~C., Hopkins,~J.~R., Punjabi,~S., Rickard,~A.~R. and }\DIFaddend Young,~J.\DIFaddbegin \DIFadd{~C.: The impact of monoaromatic hydrocarbons on OH reactivity in the coastal UK boundary layer and free troposphere, Atmospheric Chemistry and Physics, 14}\DIFaddend , \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{13, 6677--6693, 2014. }

  \DIFdelbegin %DIFDELCMD < \bibitem[{Rickard et~al.(2015)Rickard, Young, and Pascoe}]{MCM_Site}
%DIFDELCMD <   %%%
\DIFdel{Rickard}\DIFdelend 
