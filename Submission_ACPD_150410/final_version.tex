...
gas-phase chemistry in the chemical mechanism used by CTMs.  For
...
forming peroxy radicals (\chem{RO_2}) in the presence of \chem{O_2}. For
...
Table~\ref{t:mechanisms} with a~brief summary below.  We used a subset 
of the chemical reactions fully describing the degradation of the VOC 
in Table~\ref{t:initial_conditions}.  The reduced
...
chemistry. The recent review by \citet{Baklanov:2014} shows that each
...
study due to its level of detail ($16\,349$ reactions). Despite this level of detail, the MCM
had difficulties in reproducing the results of chamber study
experiments involving aromatic VOC \citep{Bloss:2005}.

The CRI \citep{Jenkin:2008} is a~reduced chemical mechanism with $1145$ reactions describing
the oxidation of the same primary VOC as the MCM v3.1 ($12\,691$ reactions).  VOC
...
the VOC. Tropospheric chemistry is described by $145$ reactions in MOZART-4.

RADM2 \citep{Stockwell:1990} describes regional scale atmospheric
chemistry using $145$ reactions with explicit species representing methane, ethane, ethene
...
representing VOC as well as revised chemistry ($193$ reactions).  RACM2 is the updated
...
emitted VOC ($315$ reactions).

CBM-IV \citep{Gery:1989} uses $46$ reactions to simulate polluted urban conditions and
...
species representing methane, ethane and acetaldehyde, and has $99$ reactions.  Other updates
...
The \chem{O_3} mixing ratios in Fig.~\ref{f:time_series} are
not simply determined by the explicitness of the chemical mechanism.
For example, the \chem{O_3} mixing ratios obtained using the Carbon Bond mechanisms 
...
Also, the \chem{O_3} mixing ratios from RACM2 and RADM2 show similar 
...
to the MCM. The further degradation of ketones hinders \chem{O_x} production
due to its low OH reactivity and photolysis rate. Thus further degradation
of HC3 proceeds through the degradation of acetaldehyde (\chem{CH3CHO}) which
propogates \chem{O_x} production through the reactions of \chem{CH_3CO_3} and
\chem{CH_3O_2} with \chem{NO}; thus the lower ketone yields leads to increased
...
radicals such as \chem{C_2H_5O_2} which promote \chem{O_x} production.
...
of VOC to produce \chem{O_3} may not be reached when using these
...
\bibitem[{Baker et~al.(2008)Baker, Beyersdorf, Doezema, Katzenstein,
  ...
  Atmos. Environ., 42, 170--182, 2008.
    ...
    \bibitem[{Baklanov et~al.(2014) Baklanov, Schl{\"u}nzen, Suppan, Baldasano, 
    ...
    Vogel, and Zhang}]{Baklanov:2014} Baklanov,~A., Schl{\"u}nzen,~K., Suppan,~P.,
...
\bibitem[{Rickard et~al.(2015)Rickard, Young, Pilling, Jenkin, Pascoe, and Saunders}]{MCM_Site} Rickard,~A., Young,~J., Pilling,~M., Jenkin.~M., Pascoe,~S., and Saunders~S.: {The Master Chemical Mechanism Version MCM v3.2}, available at: \url{http://mcm.leeds.ac.uk/MCMv3.2/} (last access: 15 July 2015), 2015.
...
\end{figure}
\begin{figure}[t]
    \includegraphics[height=120mm]{fig05.pdf}
