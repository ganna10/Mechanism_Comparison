...
Simplified mechanisms that aggregate VOC degradation products instead of aggregating at the point of the initial VOC produce comparable amounts of \ce{O3} from VOC degradation to the MCM.
...
Simplified mechanisms break down VOC into smaller sized degradation products on the first day faster than the MCM impacting the total amount of \ce{O3} produced on subsequent days.
